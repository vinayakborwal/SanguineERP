...
@IdClass(clsWebClubStateMasterModel_ID.class)
public class clsWebClubStateMasterModel implements Serializable {
	private static final long serialVersionUID = 1L;

	public clsWebClubStateMasterModel() {
	}

	public clsWebClubStateMasterModel(clsWebClubStateMasterModel_ID objModelID) {
