...
@Entity
@Table(name = "tblsalesreturntaxdtl")
public class clsSalesRetrunTaxModel {

	@Column(name = "strSRCode", columnDefinition = "VARCHAR(255) NOT NULL default ''")
	private String strSRCode;

	@Column(name = "strTaxCode", columnDefinition = "VARCHAR(255) NOT NULL default ''")
	private String strTaxCode;

	@Column(name = "strTaxDesc", columnDefinition = "VARCHAR(255) NOT NULL default ''")
