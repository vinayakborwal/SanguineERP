...
@Controller
public class clsAPGLSecurityShell {
	...
	@RequestMapping(value = "/frmAPGLSecurityShell", method = RequestMethod.GET)
	public ModelAndView funOpenSecurityShellForm(@ModelAttribute("command") @Valid clsSecurityShellBean objBean, BindingResult result, Map<String, Object> model, HttpServletRequest request) {
		...
		if ("2".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmAPGLSecurityShell_1");
		} else if ("1".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmAPGLSecurityShell");
		} else {
			return new ModelAndView("frmAPGLSecurityShell");
		}
	...
	@RequestMapping(value = "/saveAPGLSecurityShell", method = RequestMethod.POST)
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsSecurityShellBean objBean, BindingResult result, HttpServletRequest req) {
		...
		return new ModelAndView("redirect:/frmAPGLSecurityShell.html?saddr=" + urlHits);
	...
	@RequestMapping(value = "/APGLSecurity", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/LikeAPGLsersecurity", method = RequestMethod.POST)
