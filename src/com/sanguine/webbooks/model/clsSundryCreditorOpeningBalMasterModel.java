...
//@Entity
//@Table(name="tblsundarycreditoropeningbalance")
@Embeddable
public class clsSundryCreditorOpeningBalMasterModel implements Serializable {
	private static final long serialVersionUID = 1L;

	public clsSundryCreditorOpeningBalMasterModel() {
	}
