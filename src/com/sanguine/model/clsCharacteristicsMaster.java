...
@IdClass(clsCharacteristicsMaster_ID.class)
public class clsCharacteristicsMaster implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public clsCharacteristicsMaster() {
	}

	public clsCharacteristicsMaster(clsCharacteristicsMaster_ID clsCharacteristicsMaster_ID) {
