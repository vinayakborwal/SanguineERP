...
// 					 $("#hidLocCodes").val(strLocCode);
		    	...
		    	document.forms["frmSOVarienceList"].submit();
		    }
	...
	<div id="formHeading">
		<label>Sales Order Varience List</label>
	</div>
		<s:form name="frmSOVarienceList" method="POST" action="rptSOVarienceList.html" target="_blank">
	   		<br />
