...
<script type="text/javascript">
 		...
 		function funShowMISFlash()
 		{
			...
			var cmbCurrency=$("#cmbCurrency").val();
 			var searchUrl="";
 			if(type=='Amount'){
 			searchUrl=getContextPath()+"/showMonthWiseProdSaleAmount.html?fDate="+fromDate+"&tDate="+toDate+"&propCode="+propCode+"&locCode="+locCode+"&cmbCurrency="+cmbCurrency;
			//alert(searchUrl);
 			}else{
 				searchUrl=getContextPath()+"/showMonthWiseProdSaleQunatityWise.html?fDate="+fromDate+"&tDate="+toDate+"&propCode="+propCode+"&locCode="+locCode+"&cmbCurrency="+cmbCurrency;
 			}
			$.ajax({
			        type: "GET",
			        url: searchUrl,
 		...
 		function funExport(){
			...
			var type=$("#cmbType").val();
			if(type=='Amount'){
			window.location.href=getContextPath()+"/monthWiseProdSaleAmountWiseExport.html?fDate="+fromDate+"&tDate="+toDate+"&propCode="+propCode+"&locCode="+locCode+"&cmbCurrency="+cmbCurrency;
			}else{
				window.location.href=getContextPath()+"/monthWiseProdSaleQunatityWiseExport.html?fDate="+fromDate+"&tDate="+toDate+"&propCode="+propCode+"&locCode="+locCode+"&cmbCurrency="+cmbCurrency;
			}
 		}
